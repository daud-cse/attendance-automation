...
app.controller('SettingsInstituteCtrl', ['$scope', '$http', 'InstituteService', '$filter', 'toaster', function ($scope, $http, InstituteService, $filter, toaster) {
    ...
    $scope.GetAll = function () {
        InstituteService.query(function (Institutes) {
            $scope.Institutes = Institutes; // Institute.query();
            $scope.items = Institutes;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Institute = GetNewModel();
    $scope.Add = function (item) {

        InstituteService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        InstituteService.update({ id: item.Id }, item, function (result) {
