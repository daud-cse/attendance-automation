...
app.controller('SettingsAddressTypeCtrl', ['$scope', '$http', 'AddressTypeService', '$filter', 'toaster', function ($scope, $http, AddressTypeService, $filter, toaster) {

    // init
    $scope.entity = { Name: "AddressType" };
    ...
    $scope.GetAll = function () {
        AddressTypeService.query(function (AddressTypes) {
            $scope.AddressTypes = AddressTypes; // AddressType.query();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.AddressType = GetNewModel();
    $scope.Add = function (item) {

        AddressTypeService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AddressTypeService.update({ id: item.Id }, item, function (result) {
