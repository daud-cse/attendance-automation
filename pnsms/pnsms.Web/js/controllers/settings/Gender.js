...
/* Controllers */
// Gender controller
app.controller('SettingsGenderCtrl', ['$scope', '$http', 'GenderService', '$filter', 'toaster', function ($scope, $http, GenderService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Gender" };
    ...
    $scope.GetAll = function () {
        GenderService.query(function (Genders) {
            $scope.Genders = Genders; // Gender.query();
            $scope.items = Genders;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Gender = GetNewModel();
    $scope.Add = function (item) {

        GenderService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        GenderService.update({ id: item.Id }, item, function (result) {
