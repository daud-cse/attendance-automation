'use strict';
/* Controllers */
// GuardianType controller
app.controller('SettingsGuardianTypeCtrl', ['$scope', '$http', 'GuardianTypeService', '$filter', 'toaster', function ($scope, $http, GuardianTypeService, $filter, toaster) {

    // init
    $scope.entity = { Name: "GuardianType" };
    ...
    $scope.GetAll = function () {
        GuardianTypeService.query(function (GuardianTypes) {
            $scope.GuardianTypes = GuardianTypes; // GuardianType.query();
            $scope.items = GuardianTypes;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.GuardianType = GetNewModel();
    $scope.Add = function (item) {

        GuardianTypeService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        GuardianTypeService.update({ id: item.Id }, item, function (result) {
