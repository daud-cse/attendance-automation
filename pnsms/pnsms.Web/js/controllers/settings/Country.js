...
/* Controllers */
// Country controller
app.controller('SettingsCountryCtrl', ['$scope', '$http', 'CountryService', '$filter', 'toaster', function ($scope, $http, CountryService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Country" };
    ...
    $scope.GetAll = function () {
        CountryService.query(function (Countrys) {
            $scope.Countrys = Countrys; // Country.query();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Country = GetNewModel();
    $scope.Add = function (item) {

        CountryService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        CountryService.update({ id: item.Id }, item, function (result) {
