...
app.controller('AcademicClassCtrl', ['$scope', '$http', 'AcademicClassService', '$filter', 'toaster', function ($scope, $http, AcademicClassService, $filter, toaster) {
    ...
    $scope.GetAll = function () {
        AcademicClassService.query(function (academicClasses) {
            $scope.academicClasses = academicClasses;
            $scope.items = academicClasses;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.academicClass = GetNewModel();
    $scope.Add = function (item) {
        console.log(item);
        AcademicClassService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicClassService.update({ id: item.Id }, item, function (result) {
