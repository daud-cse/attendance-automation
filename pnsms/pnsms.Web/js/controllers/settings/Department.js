...
app.controller('SettingsDepartmentCtrl', ['$scope', '$http', 'DepartmentService', '$filter', 'toaster', function ($scope, $http, DepartmentService, $filter, toaster) {
    
    // init
    $scope.entity = { Name: "Department" };
    ...
    $scope.GetAll = function() {
        DepartmentService.query(function (departments) {
            $scope.departments = departments; // Department.query();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.department = GetNewModel();
    $scope.Add = function (item) {

        DepartmentService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        DepartmentService.update({ id: item.Id }, item, function (result) {
