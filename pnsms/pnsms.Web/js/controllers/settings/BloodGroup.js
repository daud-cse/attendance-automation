...
app.controller('SettingsBloodGroupCtrl', ['$scope', '$http', 'BloodGroupService', '$filter', 'toaster', function ($scope, $http, BloodGroupService, $filter, toaster) {

    // init
    $scope.entity = { Name: "BloodGroup" };
    ...
    $scope.GetAll = function () {
        BloodGroupService.query(function (BloodGroups) {
            $scope.BloodGroups = BloodGroups; // BloodGroup.query();
            $scope.items = BloodGroups;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.BloodGroup = GetNewModel();
    $scope.Add = function (item) {

        BloodGroupService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        BloodGroupService.update({ id: item.Id }, item, function (result) {
