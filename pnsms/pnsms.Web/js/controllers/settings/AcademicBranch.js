'use strict';
/* Controllers */
// AcademicBranch controller
app.controller('SettingsAcademicBranchCtrl', ['$scope', '$http', 'AcademicBranchService', '$filter', 'toaster', function ($scope, $http, AcademicBranchService, $filter, toaster) {
    
    // init
    $scope.entity = { Name: "AcademicBranch" };
   ...
   // alert("dfsdf");
    ...
    $scope.GetAll = function () {
       // alert("sds");
        AcademicBranchService.query(function (AcademicBranch) {
           // alert("sddddds");
            $scope.AcademicBranchs = AcademicBranch; // AcademicBranch.query();
            $scope.items = AcademicBranch;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.AcademicBranch = GetNewModel();
    $scope.Add = function (item) {

        AcademicBranchService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicBranchService.update({ id: item.Id }, item, function (result) {
