'use strict';
/* Controllers */
// AcademicGroup  controller
app.controller('AcademicGroupCtrl', ['$scope', '$http', 'AcademicGroupService', '$filter', 'toaster', function ($scope, $http, AcademicGroupService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Academic Group" };
    ...
    $scope.GetAll = function () {
        AcademicGroupService.query(function (academicGroups) {
            $scope.academicGroups = academicGroups;
            $scope.items = academicGroups;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.academicGroup = GetNewModel();
    $scope.Add = function (item) {
        console.log(item);
        AcademicGroupService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicGroupService.update({ id: item.Id }, item, function (result) {
