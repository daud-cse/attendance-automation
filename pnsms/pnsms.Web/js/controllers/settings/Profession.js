...
app.controller('SettingsProfessionCtrl', ['$scope', '$http', 'ProfessionService', '$filter', 'toaster', function ($scope, $http, ProfessionService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Profession" };
    ...
    $scope.GetAll = function () {
        ProfessionService.query(function (Professions) {
            $scope.Professions = Professions; // Profession.query();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Profession = GetNewModel();
    $scope.Add = function (item) {

        ProfessionService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        ProfessionService.update({ id: item.Id }, item, function (result) {
