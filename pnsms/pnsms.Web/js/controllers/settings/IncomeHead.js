'use strict';
/* Controllers */
// IncomeHead controller
app.controller('SettingsIncomeHeadCtrl', ['$scope', '$http', 'IncomeHeadService', '$filter', 'toaster', function ($scope, $http, IncomeHeadService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Income Head" };
    ...
    $scope.GetAll = function () {
        IncomeHeadService.query(function (IncomeHeads) {
            $scope.IncomeHeads = IncomeHeads; // IncomeHead.query();
            $scope.items = IncomeHeads;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.IncomeHead = GetNewModel();
    $scope.Add = function (item) {

        IncomeHeadService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        IncomeHeadService.update({ id: item.Id }, item, function (result) {
