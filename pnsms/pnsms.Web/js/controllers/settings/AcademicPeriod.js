'use strict';
/* Controllers */
// AcademicPeriod  controller
app.controller('AcademicPeriodCtrl', ['$scope', '$http', 'AcademicPeriodService', '$filter', 'toaster', function ($scope, $http, AcademicPeriodService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Academic Class" };
    ...
    $scope.GetAll = function () {        
        AcademicPeriodService.query(function (AcademicPeriodes) {
            $scope.AcademicPeriodes = AcademicPeriodes;
            $scope.items = AcademicPeriodes;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.AcademicPeriod = GetNewModel();
    $scope.Add = function (item) {
        console.log(item);
        AcademicPeriodService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicPeriodService.update({ id: item.Id }, item, function (result) {
