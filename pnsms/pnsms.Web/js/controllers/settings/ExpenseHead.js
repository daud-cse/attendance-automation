'use strict';
/* Controllers */
// ExpenseHead controller
app.controller('SettingsExpenseHeadCtrl', ['$scope', '$http', 'ExpenseHeadService', '$filter', 'toaster', function ($scope, $http, ExpenseHeadService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Expense Head" };
    ...
    $scope.GetAll = function () {
        ExpenseHeadService.query(function (ExpenseHeads) {
            $scope.ExpenseHeads = ExpenseHeads; // ExpenseHead.query();
            $scope.items = ExpenseHeads;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.ExpenseHead = GetNewModel();
    $scope.Add = function (item) {

        ExpenseHeadService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        ExpenseHeadService.update({ id: item.Id }, item, function (result) {
