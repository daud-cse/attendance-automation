...
/* Controllers */
// Marital controller
app.controller('SettingsMaritalCtrl', ['$scope', '$http', 'MaritalService', '$filter', 'toaster', function ($scope, $http, MaritalService, $filter, toaster) {
    
    // init
    $scope.entity = { Name: "Marital" };
    ...
    $scope.GetAll = function() {
        MaritalService.query(function (Maritals) {
            $scope.Maritals = Maritals; // Marital.query();
            $scope.items = Maritals;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Marital = GetNewModel();
    $scope.Add = function (item) {

        MaritalService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        MaritalService.update({ id: item.Id }, item, function (result) {
