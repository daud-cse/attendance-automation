...
app.controller('SettingsNationalityCtrl', ['$scope', '$http', 'NationalityService', '$filter', 'toaster', function ($scope, $http, NationalityService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Nationality" };
    ...
    $scope.GetAll = function () {
        NationalityService.query(function (Nationalitys) {
            $scope.Nationalitys = Nationalitys; // Nationality.query();
            $scope.items = Nationalitys;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Nationality = GetNewModel();
    $scope.Add = function (item) {

        NationalityService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        NationalityService.update({ id: item.Id }, item, function (result) {
