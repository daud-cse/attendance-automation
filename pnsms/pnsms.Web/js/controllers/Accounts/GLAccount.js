...
/* Controllers */
// Exam controller
app.controller('GLAccountCtrl', ['$scope', '$http', 'GLAccountService', '$filter', 'toaster', function ($scope, $http, GLAccountService, $filter, toaster) {

    // init
    $scope.entity = { Name: "GLAccount" };
    ...
    $scope.GetAll = function () {
        // alert("sds");
        GLAccountService.query(function (BankAccount) {
    ...
    $scope.Edit = function (item) {
        ...
        GLAccountService.New({ id: item.GLAccountId }, function (BankAccount) {
            $scope.newBankAccount = BankAccount;
            //$scope.newBankAccount.kvpBankAccountType = BankAccount.kvpBankAccountType;
        });
    };
    $scope.Update = function (item) {
       // alert(item.ID);
        ...
        GLAccountService.update({ id: item.GLAccountId }, item, function (result) {
