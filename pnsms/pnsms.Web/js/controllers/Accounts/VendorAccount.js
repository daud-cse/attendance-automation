...
/* Controllers */
// Exam controller
app.controller('VendorAccountCtrl', ['$scope', '$http', 'VendorAccountService', '$filter', 'toaster', function ($scope, $http, VendorAccountService, $filter, toaster) {

    // init
    $scope.entity = { Name: "VendorName" };
    ...
    $scope.getVendorAccountTypeId = function () {

        if ($scope.vendorAccount.VendorTypeId != null) {
            VendorAccountService.getVendorAccountTypeId({ id: $scope.vendorAccount.VendorTypeId }, function (result) {

                $scope.VendorTypeIdList = result;
                $scope.NewvendorAccount.VendorTypeIdList = $scope.VendorTypeIdList;
    ...
    $scope.GetAll = function () {
        // alert("sds");
        VendorAccountService.query(function (vendorAccount) {
            // alert("sddddds");
            $scope.vendorAccount = vendorAccount // Exam.query();
            $scope.items =vendorAccount;
            $scope.query = "";
            $scope.search();
            $scope.isEdit = false;
    ...
    $scope.New = function () {
       // alert("hello")
        ...
        VendorAccountService.New(function (vendorAccount) {

            $scope.NewvendorAccount = vendorAccount;
            $scope.NewvendorAccount.kvpVendorType = vendorAccount.kvpVendorType;
    ...
    $scope.vendorAccount = GetNewModel();

    $scope.Save = function (vendorAccount) {
        //  alert("safds");
        VendorAccountService.save(vendorAccount, function (result) {
    ...
    $scope.Update = function (item) {
        // alert(item.Id);
        VendorAccountService.update({ id: item.ID }, item, function (result) {
