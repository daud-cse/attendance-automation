...
/* Controllers */
// Exam controller
app.controller('GLSubsidyTypeCtrl', ['$scope', '$http', 'GLSubsidyTypeService', '$filter', 'toaster', function ($scope, $http, GLSubsidyTypeService, $filter, toaster) {

    // init
    $scope.entity = { Name: "GLSubsidyType" };
   ...
   // $scope.BankAccount.kvpBankAccountType = {};
    ...
    $scope.GetAll = function () {
        // alert("sds");
        GLSubsidyTypeService.query(function (GLSubsidy) {



            $scope.GLSubsidy = GLSubsidy // Exam.query();

            $scope.items = GLSubsidy;
            $scope.query = "";
            $scope.search();
            $scope.isEdit = false;
    ...
    $scope.New = function () {
        ...
        GLSubsidyTypeService.New(function (GLSubsidy) {
            $scope.newGLSubsidyType = GLSubsidy;
            $scope.newGLSubsidyType.kvpSubsidyType = GLSubsidy.kvpSubsidyType;
            $scope.newGLSubsidyType.kvpPostedGLAccount = GLSubsidy.kvpPostedGLAccount;
    ...
    $scope.Save = function (GLSubsidy) {
        //  alert("safds");
        GLSubsidyTypeService.save(GLSubsidy, function (result) {
    ...
    $scope.Edit = function (item) {
        ...
        GLSubsidyTypeService.New({ id: item.AccountId }, function (GLSubsidy) {
            $scope.newGLSubsidyType = GLSubsidy;
            $scope.newGLSubsidyType.kvpSubsidyType = GLSubsidy.kvpSubsidyType;
            $scope.newGLSubsidyType.kvpPostedGLAccount = GLSubsidy.kvpPostedGLAccount;
           // $scope.newBankAccount.kvpBankAccountType = BankAccount.kvpBankAccountType;
    ...
    $scope.Update = function (item) {
        ...
        GLSubsidyTypeService.update({ id: item.ID }, item, function (result) {
