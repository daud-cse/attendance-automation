'use strict';
/* Controllers */
app.controller('OnlineAdmissionDetailsCtrl', ['$scope', '$http', 'OnlineAdmissionService', '$filter', 'toaster', '$stateParams', 'modalService', '$state',
    function ($scope, $http, OnlineAdmissionService, $filter, toaster, $stateParams, modalService, $state) {
        ...
        $scope.UpdateApplicationForm = function () {
            ...
            $scope.VmApplicant.AdmissionForm.StatusDeatails = ($scope.VmApplicant.AdmissionForm.StatusDeatails == 1) ? true : false;
            OnlineAdmissionService.update($scope.VmApplicant.AdmissionForm, function (result) {
