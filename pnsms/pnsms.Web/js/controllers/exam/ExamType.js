...
/* Controllers */
// ExamType controller
app.controller('ExamTypeCtrl', ['$scope', '$http', 'ExamTypeService', '$filter', 'toaster', function ($scope, $http, ExamTypeService, $filter, toaster) {

    // init
    $scope.entity = { Name: "ExamType" };
    ...
    $scope.GetAll = function () {
        ...
        ExamTypeService.query(function (ExamType) {
       
            $scope.ExamTypes = ExamType; 
            $scope.items = ExamType;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.ExamType = GetNewModel();
    $scope.Add = function (item) {

        ExamTypeService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        ExamTypeService.update({ id: item.Id }, item, function (result) {
