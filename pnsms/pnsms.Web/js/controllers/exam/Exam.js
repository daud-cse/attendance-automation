...
/* Controllers */
// Exam controller
app.controller('ExamCtrl', ['$scope', '$http', 'ExamService', '$filter', 'toaster', function ($scope, $http, ExamService, $filter, toaster) {
    ...
    $scope.GetAll = function () {
        // alert("sds");
        ExamService.query(function (Exam) {
            // alert("sddddds");
            $scope.Exams = Exam; // Exam.query();
            $scope.items = Exam;
            $scope.query = "";
            $scope.search();
            $scope.isEdit = false;
    ...
    $scope.cancel=function(item){
        ...
        $scope.getScetionClasswise = function () {
            ...
            if ($scope.Exam.AcademicClassesId != null) {
                ExamService.getScetionClasswise({ id: $scope.Exam.AcademicClassesId }, function (result) {

                    $scope.AcademicSectionList = result;
                    $scope.NewExam.AcademicSectionList = $scope.AcademicSectionList;

                })
            }
        };
    $scope.getScetionClasswiseSelected = function () {

        if ($scope.selected.AcademicClassesId != null) {
            ExamService.getScetionClasswise({ id: $scope.selected.AcademicClassesId }, function (result) {
    ...
    $scope.Save = function (Exam) {
      //  alert("safds");
        ExamService.save(Exam, function (result) {
    ...
    $scope.Edit = function (item) {
     //   alert("asda");
      ...
      //  alert(item.AcademicClassesId);
        ExamService.New({ id: item.AcademicClassesId }, function (Exam) {
            $scope.NewExam = Exam;     
        });      
    };
    $scope.Update = function (item) {
       // alert(item.Id);
        ExamService.update({ id: item.Id }, item, function (result) {
