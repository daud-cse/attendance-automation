...
app.controller('FeesEnrollAutoGenerateNewCtrl', ['$scope', '$state', '$http', '$stateParams', 'FeesAutoGeneratService', 'modalService', '$filter', 'toaster', '$modal',
 function ($scope, $state, $http, $stateParams, FeesAutoGeneratService, modalService, $filter, toaster, $modal) {
     ...
     $scope.GetFeesGenerate = function () {
         FeesAutoGeneratService.newEnroll(function (result) {
     ...
     $scope.UpdateFeesAutoEnrollGenerate = function () {
         ...
         $scope.feesAutoGenModel.EnrollmentList = [];
         ...
         FeesAutoGeneratService.saveEnroll($scope.feesAutoGenModel, function (result) {
             ...
             toaster.pop("success", "Success", $scope.entity.Name + " Submitted.");
         }, function (err) {
