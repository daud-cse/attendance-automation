...
/* Controllers */
// feesType controller
app.controller('feesTypeCtrl', ['$scope', '$http', 'feesTypeService', '$filter', 'toaster', function ($scope, $http, feesTypeService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Fees Type" };
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.feesTypes = GetNewModel();
    $scope.Add = function (item) {

        console.log(item);
        feesTypeService.save(item, function (result) {
            $scope.feesType = GetNewModel();
            $scope.isNew = false;
            $scope.GetAll();
    ...
    $scope.Update = function (item) {
        feesTypeService.update({ id: item.Id }, item, function (result) {
