      ...
      .state('app.institutesettings.academicPeriod', {
          ...
          resolve: {
            ...
            /*  End Attendance */
                ...
                .state('app.certificatePrint', certificatePrint)
                .state('app.certificatePrint.create', certificatePrintCreate)
                .state('app.certificatePrint.edit', certificatePrintEdit)
                .state('app.certificatePrint.list', certificatePrintList)
                ...
                //result Publish Collection
                .state('app.resultPublish', resultPublish)
                .state('app.resultPublish.list', resultPublishList)
                .state('app.resultPublish.create', resultPublishCreate)
                .state('app.resultPublish.edit', resultPublishEdit)
               ...
               // .state('app.feesGenerateConfig.panel', feesGenerateConfigNew)
                ...
                .state('app.feesCollection', feesCollection)
                .state('app.feesCollection.feesHeads', feesHeads)
                .state('app.feesCollection.feesType', feesType)
                .state('app.feesCollection.feesSetup', feesSetup)
                .state('app.feesCollection.feesGenerateNew', feesGenerateNew)
                .state('app.feesCollection.feesCollection', feesCollectionStudent)
                .state('app.feesCollection.ledger', feesCollectionLedger)
                //Voucher Entry Collection
                .state('app.voucherEntry', voucherEntry)
                .state('app.voucherEntry.create', voucherEntryCreate)
                .state('app.voucherEntry.list', voucherEntryList)
                .state('app.voucherEntry.details', voucherEntryDetails)
                .state('app.voucherEntry.edit', voucherEntryEdit)

                 //Library Collection
                .state('app.libraryBook', libraryBook)
                .state('app.libraryBook.list', libraryBookList)

                 //eDiary
                .state('app.eDiaryList', eDiary)
                .state('app.eDiaryList.list', eDiaryList)

               ////Exam
               // .state('app.exam', exam)
               // .state('app.exam.create', examCreate)
               // .state('app.exam.list', examList)
               // .state('app.exam.details', examDetails)
               // .state('app.exam.edit', examEdit)

                //Exam Type
               .state('app.ExamType', {
                   url: '/exam/ExamType',
                   templateUrl: urlPrefix + 'tpl/exam/examType/ExamType.html',
                   // use resolve to load other dependences
                       ...
                       deps: [
                           ...
                           function ($ocLazyLoad) {
                               return $ocLazyLoad.load('toaster').then(
                                   function () {
                                       return $ocLazyLoad.load([
                                        urlPrefix + 'js/controllers/exam/ExamType.js',
                                        urlPrefix + 'js/services/exam/ExamTypeService.js'
                                       ]);
                                   }
                               );
            ...
            //Exam Grade
               .state('app.ExamGrade', {
                   url: '/exam/ExamGrade',
                   templateUrl: urlPrefix + 'tpl/exam/examGrade/ExamGrade.html',
                   // use resolve to load other dependences
                           ...
                           function ($ocLazyLoad) {
                               return $ocLazyLoad.load('toaster').then(
                                   function () {
                                       ...
                                       return $ocLazyLoad.load([
                                        urlPrefix + 'js/controllers/exam/ExamGrade.js',
                                        urlPrefix + 'js/services/exam/ExamGradeService.js'
                                       ]);
                                   }
                               );
              ...
              //Exam and Exam Type map
               .state('app.Exam', {
                   url: '/exam/Exam',
                   templateUrl: urlPrefix + 'tpl/exam/exam/Exam.html',
                   // use resolve to load other dependences
                       ...
                       deps: [
                           ...
                           function ($ocLazyLoad) {
                               return $ocLazyLoad.load('toaster').then(
                                   function () {
                                       return $ocLazyLoad.load([
                                        urlPrefix + 'js/controllers/exam/Exam.js',
                ...
                //Exam Subject Marks
               .state('app.ExamSubjectMarks', {
                   url: '/exam/ExamSubjectMark',
                   templateUrl: urlPrefix + 'tpl/exam/ExamSubjectMarks/ExamSubjectMarks.html',
                   // use resolve to load other dependences
                       ...
                       deps: [
                           ...
                           function ($ocLazyLoad) {
                               return $ocLazyLoad.load('toaster').then(
                                   function () {
                                       return $ocLazyLoad.load([
                                        urlPrefix + 'js/controllers/exam/ExamSubjectMarks.js',
                                        urlPrefix + 'js/services/exam/ExamSubjectMarksService.js'
                                       ]);
                                   }
                               );
                ...
                //Exam Process
              .state('app.ExamProcess', {
                  url: '/exam/ExamProcess',
                  templateUrl: urlPrefix + 'tpl/exam/examProcess/ExamProcess.html',
                  // use resolve to load other dependences
                      ...
                      deps: [
                          ...
                          function ($ocLazyLoad) {
                              return $ocLazyLoad.load('toaster').then(
                                  function () {
                                      return $ocLazyLoad.load([
                                       urlPrefix + 'js/controllers/exam/ExamProcess.js',
                                       urlPrefix + 'js/services/exam/ExamProcessService.js'
                                      ]);
                                  }
                              );
                ...
                //ExamTabulationSheet
             .state('app.ExamTabulationSheet', {
                 url: '/exam/ExamTabulationSheet',
                 templateUrl: urlPrefix + 'tpl/exam/ExamTabulationSheet/ExamTabulationSheet.html',
                 // use resolve to load other dependences
                     ...
                     deps: [
                         ...
                         function ($ocLazyLoad) {
                             return $ocLazyLoad.load('toaster').then(
                                 function () {
                                     return $ocLazyLoad.load([
                                      urlPrefix + 'js/controllers/exam/ExamTabulationSheet.js',
                                      urlPrefix + 'js/services/exam/ExamTabulationSheetService.js'
                                     ]);
                                 }
                             );
             ...
             }).state('app.StudentResultSheet', {
                 url: '/exam/StudentResultSheet?ExamTypeId&StudentId',
                 templateUrl: urlPrefix + 'tpl/exam/StudentResultSheet/StudentResultSheet.html',
                 // use resolve to load other dependences
                     ...
                     deps: [
                         ...
                         function ($ocLazyLoad) {
                             return $ocLazyLoad.load(['toaster']).then(
                                 function () {
                                     return $ocLazyLoad.load([
                                         urlPrefix + 'js/controllers/exam/ExamTabulationModalDetails.js',
                                         urlPrefix + 'js/services/exam/ExamTabulationModalDetailsService.js'
                                     ]);
                                 }
                             );
             ...
             .state('app.GetExamTabulationSheetCriteria', {
                 url: '/exam/GetExamTabulationSheetCriteria?ExamTypeId&StudentId',
                 templateUrl: urlPrefix + 'tpl/exam/examModal/ExamTabulationModalDetails.html',
                 // use resolve to load other dependences
             ...
             .state('app.Subjects', {
                 url: '/Subjects',
                 templateUrl: urlPrefix + 'tpl/subjects/Subjects.html',
                 // use resolve to load other dependences
                 ...
                 resolve: {
                     deps: [
                         ...
                         function ($ocLazyLoad) {
                             return $ocLazyLoad.load('toaster').then(
                                 function () {
                                     return $ocLazyLoad.load([
                                      urlPrefix + 'js/controllers/subjects/Subject.js',
                                      urlPrefix + 'js/services/subjects/SubjectService.js'
                                     ]);
                                 }
                             );
                   ...
                   //Subjects
             .state('app.InstituteSubject', {
                 url: '/InstituteSubject',
                 templateUrl: urlPrefix + 'tpl/subjects/InstituteSubject.html',
                 // use resolve to load other dependences
                     ...
                     deps: [
                         ...
                         function ($ocLazyLoad) {
                             return $ocLazyLoad.load('toaster').then(
                                 function () {
                                     return $ocLazyLoad.load([
                                      urlPrefix + 'js/controllers/subjects/InstituteSubject.js',
                                      urlPrefix + 'js/services/subjects/InstituteSubjectService.js'
                                     ]);
                                 }
                             );
              ...
              //Subjects Type
             .state('app.SubjectType', {
                 url: '/Subjects',
                 templateUrl: urlPrefix + 'tpl/subjects/SubjectType.html',
                 // use resolve to load other dependences
                     ...
                     deps: [
                         ...
                         function ($ocLazyLoad) {
                             return $ocLazyLoad.load('toaster').then(
                                 function () {
                                     return $ocLazyLoad.load([
                                      urlPrefix + 'js/controllers/subjects/SubjectType.js',
                                      urlPrefix + 'js/services/subjects/SubjectTypeService.js'
                                     ]);
                                 }
                             );
             ...
             .state('app.SubjectAcademicClassMapping', {
                 url: '/SubjectAcademicClassMapping',
                 templateUrl: urlPrefix + 'tpl/subjects/SubjectAcademicClassMapping.html',
                 // use resolve to load other dependences
                     ...
                     deps: [
                         ...
                         function ($ocLazyLoad) {
                             return $ocLazyLoad.load('toaster').then(
                                 function () {
                                     return $ocLazyLoad.load([
                                      urlPrefix + 'js/controllers/subjects/SubjectAcademicClassMapping.js',
                                      urlPrefix + 'js/services/subjects/SubjectAcademicClassMappingService.js'
                                     ]);
                                 }
                             );
            ...
            .state('app.AttendanceFileUpload', {
                ...
                resolve: {
                  ...
                  //Bank Account
                .state('app.BankAccount', BankAccount)
                  .state('app.VendorAccount', VendorAccount)
                .state('app.GLAccount', GLAccount)
                .state('app.GLSubsidyType', GLSubsidyType)
            .state('app.RelatedAccount', RelatedAccount)
