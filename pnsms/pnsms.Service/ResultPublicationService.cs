...
namespace pnsms.Service
{
       ...
       {
           private readonly IRepositoryAsync<ResultPublication> _repository;
           private readonly IImageService _imageService;
           private readonly IAcademicSessionService _sessionService;
           List<ResultPublication> Result = new List<ResultPublication>();


           public ResultPublicationService(IRepositoryAsync<ResultPublication> repository,
           ...
           {
               return _repository.Query(x => x.InstituteId == resultPublicationeModel.InstituteId && x.AcademicSessionId == resultPublicationeModel.DropDownId1).Select();
           }
           ...
           public void SaveResultPublication(IUnitOfWorkAsync unitOfWorkAsync, List<byte[]> imageList, ResultPublication resultPublicationeModel)
           {
               ...
               _repository.Insert(resultPublicationeModel);
