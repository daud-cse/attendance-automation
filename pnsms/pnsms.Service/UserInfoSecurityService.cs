...
namespace pnsms.Service
{
    ...
    {
        readonly IRepositoryAsync<UserInfoSecurity> repository;

        public UserInfoSecurityService(IRepositoryAsync<UserInfoSecurity> repository)
            : base(repository)
        {
        ...
        {
            return repository.Query(c => c.UserInfoId==Id)
                .Select()
                .FirstOrDefault();            
        }
        ...
        {
            return repository.Query(c => c.UserName == userName && c.InstituteId == instituteId)
        ...
        {
            return repository.Query(c => c.UserName == userName)
                .Include(c => c.UserInfo)
                .Select()
                .FirstOrDefault();
        }
        ...
        {
            return repository.Query(c => c.UserInfoId == serLoginId && c.InstituteId == instituteId)
                .Select()
                .FirstOrDefault();
        }
