...
namespace pnsms.Service
{
    ...
    {
        private readonly IRepositoryAsync<StudentAttendance> _repository;
        public StudentAttendanceService(IRepositoryAsync<StudentAttendance> repository)
            : base(repository)
        {
