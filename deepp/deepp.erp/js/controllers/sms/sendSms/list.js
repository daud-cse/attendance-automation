...
/* Controllers */
// Teacher controller
app.controller('SmsListCtrl', ['$scope', '$http', 'SmsService', '$filter', 'toaster',

    function ($scope, $http, SmsService, $filter, toaster) {
        // init
        ...
        $scope.GetAll = function () {
            SmsService.query(function (shortMessage) {

                $scope.shortMessage = shortMessage;
                $scope.items = shortMessage;
                $scope.query = "";
                $scope.search();
