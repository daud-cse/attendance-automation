...
/* Controllers */
// Religion controller
app.controller('SettingsReligionCtrl', ['$scope', '$http', 'ReligionService', '$filter', 'toaster', function ($scope, $http, ReligionService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Religion" };
    ...
    $scope.GetAll = function () {
        ReligionService.query(function (Religions) {
            $scope.Religions = Religions; // Religion.query();
            $scope.items = Religions;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Religion = GetNewModel();
    $scope.Add = function (item) {

        ReligionService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        ReligionService.update({ id: item.Id }, item, function (result) {
