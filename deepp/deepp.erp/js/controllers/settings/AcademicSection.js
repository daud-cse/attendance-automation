'use strict';
/* Controllers */
// AcademicSection  controller
app.controller('AcademicSectionCtrl', ['$scope', '$http', 'AcademicSectionService', '$filter', 'toaster', function ($scope, $http, AcademicSectionService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Academic Section" };
    ...
    $scope.GetAll = function () {
        AcademicSectionService.query(function (academicSections) {
            $scope.academicSections = academicSections;
            $scope.items = academicSections;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.academicSection = GetNewModel();
    $scope.Add = function (item) {
        console.log(item);
        AcademicSectionService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicSectionService.update({ id: item.Id }, item, function (result) {
