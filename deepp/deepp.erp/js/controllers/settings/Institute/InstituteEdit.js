...
app.controller('SettingsInstituteEditCtrl', ['$scope', '$http', 'InstituteService', '$filter', 'toaster', '$stateParams', '$location', 'FileUploader', '$modal',
    function ($scope, $http, InstituteService, $filter, toaster, $stateParams, $location,FileUploader, $modal) {
    ...
    $scope.GetNew = function () {
        InstituteService.get({ id: $stateParams.instituteId, 'foobar': new Date().getTime() }, function (Institute) {
    ...
    function updateInstitute() {
        $scope.isLoading = true;
        //$scope.Institute.GlobalCountry = null;
        //$scope.Institute.GlobalDivision = null;
        //$scope.Institute.GlobalDistrict= null;
        //$scope.Institute.GlobalSubDistrict= null;
        //$scope.Institute.GlobalInstituteType = null;
        ...
        InstituteService.update({ id: $scope.Institute.Id }, institute, function (result) {
