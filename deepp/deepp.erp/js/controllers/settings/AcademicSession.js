'use strict';
/* Controllers */
// AcademicSession  controller
app.controller('AcademicSessionCtrl', ['$scope', '$http', 'AcademicSessionService', '$filter', 'toaster', function ($scope, $http, AcademicSessionService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Academic Session" };
    ...
    $scope.GetAll = function () {
        AcademicSessionService.query(function (academicSessions) {
            $scope.academicSessions = academicSessions;
            $scope.items = academicSessions;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.academicSession = GetNewModel();
    $scope.Add = function (item) {
        console.log(item);
        AcademicSessionService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicSessionService.update({ id: item.Id }, item, function (result) {
...
function GetNewModel() {
    return { Id: 0, IsActive: true, Name: "", Description: "", InstituteId: 1 ,StartAt:"",EndAt:""};
