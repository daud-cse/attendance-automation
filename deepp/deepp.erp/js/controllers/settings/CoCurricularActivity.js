'use strict';
/* Controllers */
// CoCurricularActivity controller
app.controller('CoCurricularActivityCTrl', ['$scope', '$http', 'CoCurricularActivityService', '$filter', 'toaster', function ($scope, $http, CoCurricularActivityService, $filter, toaster) {

    // init
    $scope.entity = { Name: "CoCurricularActivity" };
    ...
    $scope.GetAll = function () {
        CoCurricularActivityService.query(function (CoCurricularActivities) {
            $scope.CoCurricularActivities = CoCurricularActivities; // CoCurricularActivity.query();
            $scope.items = CoCurricularActivities;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.CoCurricularActivity = GetNewModel();
    $scope.Add = function (item) {

        CoCurricularActivityService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        CoCurricularActivityService.update({ id: item.Id }, item, function (result) {
