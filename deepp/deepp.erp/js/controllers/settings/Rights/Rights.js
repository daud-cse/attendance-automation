...
/* Controllers */
// Rights  controller
app.controller('RightsCtrl', ['$scope', '$http', 'RightsService', '$filter', 'toaster', function ($scope, $http, RightsService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Righ" };
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Rights = GetNewModel();
    $scope.Add = function (item) {
        console.log(item);
        RightsService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        RightsService.update({ id: item.Id }, item, function (result) {
