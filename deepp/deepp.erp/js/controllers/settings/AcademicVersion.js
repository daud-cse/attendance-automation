...
app.controller('SettingsAcademicVersionCtrl', ['$scope', '$http', 'AcademicVersionService', '$filter', 'toaster', function ($scope, $http, AcademicVersionService, $filter, toaster) {

    // init
    $scope.entity = { Name: "AcademicVersion" };
    ...
    $scope.GetAll = function () {
        AcademicVersionService.query(function (AcademicVersions) {
            $scope.AcademicVersions = AcademicVersions; // AcademicVersion.query();
            $scope.items = AcademicVersions;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.AcademicVersion = GetNewModel();
    $scope.Add = function (item) {

        AcademicVersionService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicVersionService.update({ id: item.Id }, item, function (result) {
