'use strict';
/* Controllers */
// AcademicShift controller
app.controller('SettingsAcademicShiftCtrl', ['$scope', '$http', 'AcademicShiftService', '$filter', 'toaster', function ($scope, $http, AcademicShiftService, $filter, toaster) {

    // init
    $scope.entity = { Name: "AcademicShift" };
    ...
    $scope.GetAll = function () {
        AcademicShiftService.query(function (AcademicShifts) {
            $scope.AcademicShifts = AcademicShifts; // AcademicShift.query();
            $scope.items = AcademicShifts;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.AcademicShift = GetNewModel();
    $scope.Add = function (item) {

        AcademicShiftService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        AcademicShiftService.update({ id: item.Id }, item, function (result) {
