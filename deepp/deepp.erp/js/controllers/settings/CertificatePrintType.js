'use strict';
/* Controllers */
// AcademicVersion controller
app.controller('CertificatePrintTypeCtrl', ['$scope', '$http', 'CertificatePrintTypeService', '$filter', 'toaster', function ($scope, $http, CertificatePrintTypeService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Certificate Print Type" };
    ...
    $scope.GetAll = function () {
        CertificatePrintTypeService.query(function (certificatePrintTypes) {
            $scope.CertificatePrintTypes = certificatePrintTypes; // AcademicVersion.query();
            $scope.items = certificatePrintTypes;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.CertificatePrintType = GetNewModel();
    $scope.Add = function (item) {

        CertificatePrintTypeService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        CertificatePrintTypeService.update({ id: item.Id }, item, function (result) {
...
function GetNewModel() {
    return { Id: 0, IsActive: true, Name: "", InstituteId: 1 };
