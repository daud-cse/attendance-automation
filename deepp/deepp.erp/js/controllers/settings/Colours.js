...
/* Controllers */
// Colours controller
app.controller('SettingsColoursCtrl', ['$scope', '$http', 'ColoursService', '$filter', 'toaster', function ($scope, $http, ColoursService, $filter, toaster) {

    // init
   // alert($scope);
    //console.log($scope);
    
    $scope.entity = { Name: "Colours" };
    ...
    $scope.GetAll = function () {
        ColoursService.query(function (Colourss) {
            $scope.Colourss = Colourss; // Colours.query();
            $scope.items = Colourss;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Colours = GetNewModel();
    $scope.Add = function (item) {

        ColoursService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        ColoursService.update({ id: item.Id }, item, function (result) {
...
function GetNewModel() {
    return {   IsActive: true, Name: "", ColorCode: "" };
