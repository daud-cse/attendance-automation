...
app.controller('ScholarshipCTrl', ['$scope', '$http', 'ScholarshipService', '$filter', 'toaster', function ($scope, $http, ScholarshipService, $filter, toaster) {

    // init
    $scope.entity = { Name: "Scholarship" };
    ...
    $scope.GetAll = function () {
        ScholarshipService.query(function (scholarships) {
            $scope.Scholarships = scholarships; // Scholarship.query();
            $scope.items = scholarships;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.Scholarship = GetNewModel();
    $scope.Add = function (item) {

        ScholarshipService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        ScholarshipService.update({ id: item.Id }, item, function (result) {
