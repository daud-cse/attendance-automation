'use strict';
/* Controllers */
// EducationalQualification controller
app.controller('SettingsEducationalQualificationCtrl', ['$scope', '$http', 'EducationalQualificationService', '$filter', 'toaster', function ($scope, $http, EducationalQualificationService, $filter, toaster) {

    // init
    $scope.entity = { Name: "EducationalQualification" };
    ...
    $scope.GetAll = function () {
        EducationalQualificationService.query(function (EducationalQualifications) {
            $scope.EducationalQualifications = EducationalQualifications; // EducationalQualification.query();
            $scope.items = EducationalQualifications;
            $scope.query = "";
            $scope.search();
    ...
    // inline Add /Edit
    $scope.GetAll();
    $scope.EducationalQualification = GetNewModel();
    $scope.Add = function (item) {

        EducationalQualificationService.save(item, function (result) {
    ...
    $scope.Update = function (item) {
        EducationalQualificationService.update({ id: item.Id }, item, function (result) {
