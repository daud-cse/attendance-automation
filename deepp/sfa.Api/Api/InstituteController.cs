    ...
    public class InstituteController : ApiController
    {
        ...
        public void PutSliderImage(int id, [FromBody]Institute institute)
        {
            ...
            if (Sessions.Temp != null)
            {
                ...
                if (images != null)
                {
                    imageList.AddRange(images.Select(image => new pnsms.Entities.Models.Image() { RefTypeId = (int)pnsms.utility.RefCode.Institute_Landing_Slider, ImageBinaryData = image }));
                }
