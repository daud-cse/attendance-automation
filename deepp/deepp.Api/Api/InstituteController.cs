    ...
    public class InstituteController : ApiController
    {
        ...
        public void PutSliderImage(int id, [FromBody]Institute institute)
        {
            ...
            if (Sessions.Temp != null)
            {
                ...
                if (images != null)
                {
                    imageList.AddRange(images.Select(image => new deepp.Entities.Models.Image() { RefTypeId = (int)deepp.utility.RefCode.Institute_Landing_Slider, ImageBinaryData = image }));
                }
