...
namespace pnsms.landing.Controllers
{
    public class AccountController : Controller
    {
        ...
        string RedirectUrl(int userInfoId)
        {
            ...
            if (userInfo.UserInfoTypeId == (int)pnsms.utility.UserInfoType.Employee)
            {
                return "~/erp";
            }
            else if (userInfo.UserInfoTypeId == (int)pnsms.utility.UserInfoType.Teacher)
            {
                return "~/erp";
            }
            else if (userInfo.UserInfoTypeId == (int)pnsms.utility.UserInfoType.Student)
            {
                return "~/portal";
            }
            else if (userInfo.UserInfoTypeId == (int)pnsms.utility.UserInfoType.Guardian)
            {
                return "~/portal";
            }
            else if (userInfo.UserInfoTypeId == (int)pnsms.utility.UserInfoType.Global_Users)
            {
                return "~/portal";
            }
            else if (userInfo.UserInfoTypeId == (int)pnsms.utility.UserInfoType.Governingbody)
            {
                return "~/portal";
            }
            return "";
