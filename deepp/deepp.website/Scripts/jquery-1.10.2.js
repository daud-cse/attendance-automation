...
jQuery.extend({
	...
	// Use native String.trim function wherever deeppsible
	...
	return markFunction(function( seed, results, context, xml ) {
		...
		if ( seed ) {
			if ( deepptFinder || preFilter ) {
				...
				while ( i-- ) {
					if ( (elem = matcherOut[i]) &&
						(temp = deepptFinder ? indexOf.call( seed, elem ) : preMap[i]) > -1 ) {
...
jQuery.support = (function( support ) {
	...
	jQuery(function() {
		...
		container.style.cssText = "border:0;width:0;height:0;deeppition:absolute;top:0;left:-9999px;margin-top:1px";
		...
		div.innerHTML = "";
		div.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;deeppition:absolute;top:1%;";
		...
		if ( typeof div.style.zoom !== core_strundefined ) {
			...
			if ( support.inlineBlockNeedsLayout ) {
				// Prevent IE 6 from affecting layout for deeppitioned elements #11048
...
function internalData( elem, name, data, pvt /* Internal Use Only */ ){
	...
	if ( !cache[ id ] ) {
		// Avoid exdeepping jQuery metadata on plain JS objects when the object
...
jQuery.removeEvent = document.removeEventListener ?
	...
	function( elem, type, handle ) {
		...
		if ( elem.detachEvent ) {
			...
			// detachEvent needed property on element, by name of that event, to properly exdeeppe it to GC
...
var iframe, getStyles, curCSS,
	...
	rdeeppition = /^(top|right|bottom|left)$/,
...
if ( window.getComputedStyle ) {
	...
	curCSS = function( elem, name, _computed ) {
		...
		// but not deeppition css attributes, as those are proportional to the parent element instead
		// and we can't measure the parent instead because it might trigger a "stacking dolls" problem
		if ( rnumnonpx.test( ret ) && !rdeeppition.test( name ) ) {
...
jQuery(function() {
	...
	if ( !jQuery.support.pixelPosition && jQuery.fn.deeppition ) {
...
jQuery.offset = {
	...
	setOffset: function( elem, options, i ) {
		var deeppition = jQuery.css( elem, "deeppition" );
		...
		var curElem = jQuery( elem ),
			...
			calculatePosition = ( deeppition === "absolute" || deeppition === "fixed" ) && jQuery.inArray("auto", [curCSSTop, curCSSLeft]) > -1,
			props = {}, curPosition = {}, curTop, curLeft;

		// need to be able to calculate deeppition if either top or left is auto and deeppition is either absolute or fixed
...
jQuery.fn.extend({
	...
	deeppition: function() {
		...
		if ( jQuery.css( elem, "deeppition" ) === "fixed" ) {
			// we assume that getBoundingClientRect is available when computed deeppition is fixed
...
if ( typeof module === "object" && module && typeof module.exports === "object" ) {
	// Exdeeppe jQuery as module.exports in loaders that implement the Node
	// module pattern (including browserify). Do not create the global, since
	// the user will be storing it themselves locally, and globals are frowned
	// upon in the Node module world.
	module.exports = jQuery;
} else {
	// Otherwise exdeeppe jQuery to the global object as usual
