...
namespace pnsms.Service
{
    ...
    public class RoleService : IRoleService
    {
        ...
        public RoleService(IRepositoryAsync<Role> repository, IRightsOfRoleService rightsOfRoleService)
        {
        ...
        {
            return
                _repository.Query(d => d.InstituteId.Equals(instituteId) && d.IsActive == true && d.IsForTeacher== true)
                    .Select();
        ...
        {
            return
                _repository.Query(d => d.InstituteId.Equals(instituteId) && d.IsActive == true && d.IsForEmployee == true)
                    .Select();
        ...
        {
            return
                _repository.Query(d => d.InstituteId.Equals(instituteId) && d.IsActive == true && d.IsForGuardian == true)
                    .Select();
        ...
        {
            var role = _repository.Query(r => r.Id.Equals(id)).Select().SingleOrDefault();
            if (role != null)
            {
