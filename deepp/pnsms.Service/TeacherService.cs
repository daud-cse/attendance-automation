...
namespace pnsms.Service
{
    ...
    public class TeacherService : Service<Teacher>, ITeacherService
    {
        ...
        public TeacherService(IRepositoryAsync<Teacher> repository,
        ...
        public IEnumerable<Teacher> GetAllTeacher(int instituteId, string searchText = "", int? branchId = null, bool? isActive = null)
        {
            ...
            return _repository.Query(predicate).Include(u => u.UserInfo)
        ...
        public IEnumerable<ShortMessageDetail> GetAllShortMessageDetail(int instituteId, int userId, Teacher teacher = null)
        {
            ...
            var result = _repository.Query(predicate)
        ...
        {
            var teacher = _repository.Query(x => x.TeacherId == id)
        ...
        {
            var data = _repository.Query(c => c.UserInfo.IsActive && c.UserInfo.InstituteId==instituteId).Include(s => s.UserInfo).Select().ToList();
