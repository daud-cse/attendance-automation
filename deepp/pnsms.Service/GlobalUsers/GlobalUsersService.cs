...
namespace pnsms.Service.GlobalUsers
{
    ...
    {
        private readonly IRepositoryAsync<GlobalUser> _repository;
        ...
        public GlobalUserService(IRepositoryAsync<GlobalUser> repository,
        ...
        {
            var GlobalUser = _repository.Query(x => x.GlobalUserId == id)
