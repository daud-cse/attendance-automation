...
namespace pnsms.Service
{
    ...
    {
        private readonly IRepositoryAsync<MobilePayment> _repository;
        private readonly IPaymentTypeService _paymentTypeService;
        private readonly IUserInfoService _userInfoService;
        List<Notice> Notice = new List<Notice>();


        public MobilePaymentService(IRepositoryAsync<MobilePayment> repository, IPaymentTypeService paymentTypeService,
        ...
        public bool SaveMobilePayment(IUnitOfWorkAsync unitOfWorkAsync, MobilePayment mPaymentModel)
        {
            ...
            if (userDetails != null)
            {
                ...
                _repository.Insert(mPaymentModel);
        ...
        public bool UpdateMobilePayment(IUnitOfWorkAsync unitOfWorkAsync, MobilePayment mPaymentModel)
        {
            ...
            if (userDetails != null)
            {
                ...
                _repository.Update(entrymPaymentModel);
                unitOfWorkAsync.SaveChanges();
        ...
        {
            var payment = _repository.Query(x => x.Id == id)
        ...
        public IEnumerable<MobilePayment> GetPaymentsByStudentId(int studentId)
        {
            ...
            return _repository.Query(x => x.ReffStudentId == studentId).Select();
        } 
