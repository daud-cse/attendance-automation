...
using pnsms.Entities.ResponseModel;
...
namespace pnsms.Service.ViewModels
{
    ...
    public class VmStudentAttendanceService : IVmStudentAttendanceService
    {
        ...
        public VmStudentAttendanceService(
            ...
            , ISubjectAcademicClassMappingService subjectAcademicClassMappingService
            )
        {
        ...
        public List<TakeAttendance> GetVmStudentAttendanceByTeacher(int instituteId, int sessionsId, int userId)
        {
            ...
            var subjectAcademicClassMappinglst = _subjectAcademicClassMappingService.GetAllMappingByCriteria(instituteId, sessionsId, 0, 0, userId);
