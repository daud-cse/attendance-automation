...
namespace deepp.Service
{
    ...
    public class ScholarshipOfStudentService : Service<ScholarshipOfStudent>, IScholarshipOfStudentService
    {
        ...
        /// The _redeeppitory
        /// </summary>
        private readonly IRepositoryAsync<ScholarshipOfStudent> _redeeppitory;
        ...
        public ScholarshipOfStudentService(IRepositoryAsync<ScholarshipOfStudent> redeeppitory)
            : base(redeeppitory)
        {
        ...
        public void SaveScholarshipOfStudent(IUnitOfWorkAsync unitOfWorkAsync, int studentId,int academicSessionId, List<int> scholarships)
        {
            ...
            {
                _redeeppitory.Insert(new ScholarshipOfStudent
                {
                    StudentId = studentId,
                    ScholarshipId = sid,
