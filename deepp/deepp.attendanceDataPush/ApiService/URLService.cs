  ...
  public  class URLService
    {
       ...
       //public static String URL_HOST = "http://localhost:1692/";
        ...
        public static String URL_POSTLISTMACHINEINFO_For_BOTH = URL_HOST + "api/attendanceboth/machinedatapostbothattendance";
        public static String URL_POSTLISTMACHINEINFO_For_BOTHDataMigration = URL_HOST + "api/attendanceboth/machinedatapostbothattendancedatamigration";
        ...
        public static String URL_GET_ATTENDANCEDATASYNINFO_For_Both = URL_HOST + "api/attendanceboth/getattendancedatasyninfoboth?Machineinfo=";
