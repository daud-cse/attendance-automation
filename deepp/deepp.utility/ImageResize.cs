    ...
    public class ImageResize : IImageResize
    {
        ...
        {            
            ...
            if (width < originalWidth || height < originalHeight)
            {
                ...
                int newX = 0;
                //Set the new top left drawing deeppition on the image canvas
                int newY = 0;
                Double reDuce;

                //Keep the aspect ratio of image the same if not 4:3 and work out the newX and newY deeppitions
                ...
                //Save the new bitmap image using 'Png' picture format and the calculated canvas deeppitioning
