...
// Comdeeppite line charts, the second using values supplied via javascript
$('#comdeeppiteline').sparkline('html', { fillColor: false, changeRangeMin: 0, chartRangeMax: 10 });
$('#comdeeppiteline').sparkline([4,1,5,7,9,9,8,7,6,6,4,7,8,4,3,2,2,5,6,7], {comdeeppite: true, fillColor: false, lineColor: 'red', changeRangeMin: 0, chartRangeMax: 10 });


// Bar + line comdeeppite charts
$('#comdeeppitebar').sparkline('html', { type: 'bar', barColor: '#aaf' });
$('#comdeeppitebar').sparkline([4,1,5,7,9,9,8,7,6,6,4,7,8,4,3,2,2,5,6,7], {comdeeppite: true, fillColor: false, lineColor: 'red' });
...
$('#bigstacked').sparkline([4,1,5,7,9,9,8,7,6,6,4,7,8,4,3,2,2,5,6,7,8], { comdeeppite: true, fillColor: false, lineColor: 'red', height: '200px', width: '100%' });
