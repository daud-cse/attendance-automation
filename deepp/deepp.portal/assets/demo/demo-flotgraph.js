$(function () {
    ...
    $("#sincos").bind("plothover", function (event, deepp, item) {
        $("#x").text(deepp.x.toFixed(2));
        $("#y").text(deepp.y.toFixed(2));
    ...
    $("#sincos").bind("plotclick", function (event, deepp, item) {
        if (item) {
    ...
    function pieHover(event, deepp, obj)
    {
            if (!obj)
                    return;
