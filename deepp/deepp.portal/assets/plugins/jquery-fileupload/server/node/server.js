...
(function (port) {
    ...
    var path = require('path'),
        ...
        options = {
            ...
            accessControl: {
                ...
                allowHeaders: 'Content-Type, Content-Range, Content-Disdeeppition'
            },
        ...
        serve = function (req, res) {
            ...
            var handleResult = function (result, redirect) {
                ...
                setNoCacheHeaders = function () {
                    ...
                    res.setHeader('Content-Disdeeppition', 'inline; filename="files.json"');
                },
    ...
    fileServer.respond = function (pathname, status, _headers, files, stat, req, res, finish) {
        ...
        if (!options.inlineFileTypes.test(files[0])) {
            ...
            _headers['Content-Disdeeppition'] = 'attachment; filename="' +
    ...
    UploadHandler.prototype.deeppt = function () {
        var handler = this,
