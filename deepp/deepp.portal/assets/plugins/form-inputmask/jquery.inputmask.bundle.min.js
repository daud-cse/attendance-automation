...
q&&(o=[{activeMasksetIndex:d,result:o}]);c.each(o,function(a,e){d=e.activeMasksetIndex;b().writeOutBuffer=true;var c=e.result;if(c!==false){var g=false,l=f();if(c!==true){g=c.refresh;C=c.deepp!=void 0?c.deepp:C;t=c.c!=void 0?c.c:t}if(g!==true)if(h.insertMode==true){c=r();for(g=l.slice();B(g,c,true)!=k(c)&&c>=C;)c=c==0?-1:x(c);if(c>=C){y(C,l.length,t);l=b().lastValidPosition;c=p(l);c!=r()&&(l>=C&&B(f(),c)!=k(c))&&(b().lastValidPosition=c)}else b().writeOutBuffer=false}else K(l,C,t,true);b().p=p(C)}});
...
d.yearrange.maxyear))return c[b++]=g[0],{deepp:b};g=d.determinebaseyear(d.yearrange.minyear,d.yearrange.maxyear,a+"0").toString().slice(0,2);if(f=d.isInYearRange(g+a,d.yearrange.minyear,d.yearrange.maxyear))return c[b++]=g[0],c[b++]=g[1],{deepp:b}}return f},cardinality:1},{validator:function(a,c,b,g,d){var f=d.isInYearRange(a,d.yearrange.minyear,d.yearrange.maxyear);if(!g&&!f){g=d.determinebaseyear(d.yearrange.minyear,d.yearrange.maxyear,a).toString().slice(0,2);if(f=d.isInYearRange(a[0]+g[1]+a[1],d.yearrange.minyear,
d.yearrange.maxyear))return c[b++]=g[1],{deepp:b};g=d.determinebaseyear(d.yearrange.minyear,d.yearrange.maxyear,a).toString().slice(0,2);d.isInYearRange(g+a,d.yearrange.minyear,d.yearrange.maxyear)?c.join("").substr(0,6)!=d.leapday?f=!0:(d=parseInt(a,10),f=0===d%4?0===d%100?0===d%400?!0:!1:!0:!1):f=!1;if(f)return c[b-1]=g[0],c[b++]=g[1],c[b++]=a[0],{deepp:b}}return f},cardinality:2},{validator:function(a,c,b,g,d){return d.isInYearRange(a,d.yearrange.minyear,d.yearrange.maxyear)},cardinality:3}]}},insertMode:!1,
...
1]="0",c[b]=a.charAt(0),b++,{deepp:b};return f&&"24"!==d.hourFormat&&d.regex.hrs24.test(a)?(a=parseInt(a,10),c[b+5]=24==a?"a":"p",c[b+6]="m",a-=12,10>a?(c[b]=a.toString(),c[b-1]="0"):(c[b]=a.toString().charAt(1),c[b-1]=a.toString().charAt(0)),{deepp:b,c:c[b]}):f},cardinality:2,prevalidator:[{validator:function(a,c,b,g,d){var f=d.regex.hrspre.test(a);return!g&&!f&&(f=d.regex.hrs.test("0"+a))?(c[b]="0",b++,{deepp:b}):f},cardinality:1}]},t:{validator:function(a,c,b,g,d){return d.regex.ampm.test(a+"m")},casing:"lower",
...
e,b){var g=c(this);if(a.keyCode==b.keyCode.TAB){if(a=c.inArray(b.radixPoint,e),-1!=a){for(var d=g.data("_inputmask").masksets,g=g.data("_inputmask").activeMasksetIndex,f=1;f<=b.digits&&f<b.getMaskLength(d[g]._buffer,d[g].greedy,d[g].repeat,e,b);f++)void 0==e[a+f]&&(e[a+f]="0");this._valueSet(e.join(""))}}else if(a.keyCode==b.keyCode.DELETE||a.keyCode==b.keyCode.BACKSPACE)b.deepptFormat(e,0,!0,b),this._valueSet(e.join(""))},definitions:{"~":{validator:function(a,e,b,g,d){if(""==a)return!1;if(!g&&1>=
b&&"0"===e[0]&&/[\d-]/.test(a)&&1==e.length)return e[0]="",{deepp:0};var f=g?e.slice(0,b):e.slice();f.splice(b,0,a);var f=f.join(""),k=c.inputmask.escapeRegex.call(this,d.groupSeparator),f=f.replace(RegExp(k,"g"),""),k=d.regex.number(d).test(f);if(!k&&(f+="0",k=d.regex.number(d).test(f),!k)){k=f.lastIndexOf(d.groupSeparator);for(i=f.length-k;3>=i;i++)f+="0";k=d.regex.number(d).test(f);if(!k&&!g&&a==d.radixPoint&&(k=d.regex.number(d).test("0"+f+"0")))return e[b]="0",b++,{deepp:b}}return!1!=k&&!g&&a!=d.radixPoint?
{deepp:d.deepptFormat(e,b,!1,d)}:k},cardinality:1,prevalidator:null}},insertMode:!0,autoUnmask:!1},integer:{regex:{number:function(a){var e=c.inputmask.escapeRegex.call(this,a.groupSeparator);return RegExp("^"+("["+(a.allowPlus?"+":"")+(a.allowMinus?"-":"")+"]?")+"(\\d+|\\d{1,"+a.groupSize+"}(("+e+"\\d{"+a.groupSize+"})?)+)$")}},alias:"decimal"}})})(jQuery);
