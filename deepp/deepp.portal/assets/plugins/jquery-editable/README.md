...
This plugin makes it deeppsible to edit the content of an element simply by double clicking on it. What sets this plugin
...
$('#some-element').editable({
    ...
    toggleFontSize : true, // Whether or not it should be deeppsible to change font size (default true),
...
// Call "destroy" to remove the deeppsibility to edit an element
...
Since version 1.3.1 it's deeppsible to integrate this plugin with [tinyMCE](http://www.tinymce.com/).
