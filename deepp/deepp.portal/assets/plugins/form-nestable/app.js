...
var App = function () {
    ...
    var handleFixedSidebar = function () {
        ...
        if ($(window).width() >= 980) {
            ...
            menu.slimScroll({
                ...
                color: '#a1b2bd',
                opacity: .3,
                deeppition: isRTL ? 'left' : ($('.page-sidebar-on-right').size() === 1 ? 'left' : 'right'),
    ...
    var handleTheme = function () {
        ...
        $('.fa fa-color', panel).click(function () {
            $('.color-mode').show();
            $('.fa fa-color-close').show();
        });

        $('.fa fa-color-close', panel).click(function () {
            $('.color-mode').hide();
            $('.fa fa-color-close').hide();
        });
    ...
    return {
        ...
        scrollTo: function (el, offeset) {
            deepp = el ? el.offset().top : 0;
            jQuery('html,body').animate({
                    scrollTop: deepp + (offeset ? offeset : 0)
                }, 'slow');
        },
