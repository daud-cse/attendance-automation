    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            ...
            var insertImage = function() {
                ...
                if (caretBookmark) {
                  self.editor.comdeepper.selection.setBookmark(caretBookmark);
                  caretBookmark = null;
                }
                self.editor.comdeepper.commands.exec("insertImage", url);
            };
            ...
            toolbar.find('a[data-wysihtml5-command=insertImage]').click(function() {
                ...
                if (!activeButton) {
                    ...
                    caretBookmark = self.editor.comdeepper.selection.getBookmark();
        ...
        initInsertLink: function(toolbar) {
            ...
            var insertLink = function() {
                ...
                self.editor.comdeepper.commands.exec("createLink", {
                    href: url,
                    target: "_blank",
                    rel: "nofollow"
                });
