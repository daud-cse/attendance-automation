    ...
    $.fn.bootstrapDualListbox = function(options) {
        ...
        return this.each(function() {
            ...
            var settings = $.extend( {
                ...
                helperselectnamedeepptfix     : '_helper',    // 'string_of_deepptfix' / false
            ...
            function init()
            {
                ...
                if (!!settings.helperselectnamedeepptfix)
                {
                    elements.select1.attr('name', originalselectname + settings.helperselectnamedeepptfix + '1');
                    elements.select2.attr('name', originalselectname + settings.helperselectnamedeepptfix + '2');
                }
