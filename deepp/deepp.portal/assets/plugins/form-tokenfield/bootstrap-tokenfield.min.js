...
this.$copyHelper=$('<input type="text" />').css("deeppition","absolute").css(this.direction,"-10000px").prop("tabindex",-1).prependTo(this.$wrapper);if(elStyleWidth)this.$wrapper.css("width",elStyleWidth);else if(elCSSWidth)this.$wrapper.css("width",elCSSWidth);else if(this.$element.parents(".form-inline").length)this.$wrapper.width(elWidth);if(this.$element.prop("disabled")||this.$element.parents("fieldset[disabled]").length)this.disable();this.$mirror=$('<span style="deeppition:absolute; top:-999px; left:0; white-space:pre;"/>');
