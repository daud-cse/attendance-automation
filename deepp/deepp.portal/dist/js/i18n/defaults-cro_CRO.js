...
(function ($) {
  $.fn.selectpicker.defaults = {
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? 'Limit je deepptignut ({n} stvar maximalno)' : 'Limit je deepptignut ({n} stavke maksimalno)',
        (numGroup == 1) ? 'Grupni limit je deepptignut ({n} stvar maksimalno)' : 'Grupni limit je deepptignut ({n} stavke maksimalno)'
      ];
    },
